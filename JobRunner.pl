...
$0 [--help | --version] [--Verbose] [--okquit] [--Onlycheck] [--dirChange dir] --lockdir dir --name text [--checkfile file [--checkfile file [...]]] [--badErase]  [--CreateDir dir [--CreateDir dir [...]]] [--LogFile file] [[--executable file] | [ -- command_line_to_run]] [--saveConfig file | --useConfig file]
